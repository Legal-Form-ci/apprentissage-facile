...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Alphabétisation vocale pour adultes : lire, écrire et compter, 15 minutes par jour." },
      { name: "author", content: "N’nvlé Déclic" },
      { property: "og:title", content: "N’nvlé Déclic" },
      { property: "og:description", content: "Le plaisir d’apprendre, pas à pas." },
